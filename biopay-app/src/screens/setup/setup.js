...
import {CloudPublicKeyEncryption} from '../../utils/constants';
import {
  checkBiometrics,
...
export default class Setup extends Component {
  ...
  createWallet() {
    ...
    setTimeout(() => {
      ...
      this.setState({
        ...
        publicKey: keypair.getPublicKey().toIotaAddress(),
  ...
  async completeSetup() {
    const {mnemonic, publicKey, privateKey} = this.state;
        ...
        {this.state.stage === 0 && (
          <Fragment>
            ...
            <Text
              ...
              Secure decentralized wallet with FaceDID, optimized savings, and
            ...
            <View style={GlobalStyles.buttonContainer}>
              ...
              <Pressable
                ...
                <Text
                  ...
                  {this.state.loading ? 'Creating Wallet...' : 'Create Wallet'}
                </Text>
              </Pressable>
            </View>
          </Fragment>
          ...
          <Fragment>
            ...
            <View style={{width: '94%'}}>
              <Text style={GlobalStyles.description}>
                Your wallet recovery depends{"\nr"}on this—keep it safe!
              </Text>
            </View>
            <View
              style={{
