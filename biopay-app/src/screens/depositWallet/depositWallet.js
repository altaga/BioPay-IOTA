    ...
    return (
      <SafeAreaView style={[GlobalStyles.container]}>
        ...
        <View
          ...
          <Text style={GlobalStyles.title}>Receive IOTA{'\n'}or Coins</Text>
          ...
          <View
            ...
            <Text
              ...
              {publicKey.substring(
                Math.floor((publicKey.length * 0) / 3),
                Math.floor((publicKey.length * 1) / 3),
              ) +
                '\n' +
                publicKey.substring(
                  Math.floor((publicKey.length * 1) / 3),
                  Math.floor((publicKey.length * 2) / 3),
                ) +
                '\n' +
                publicKey.substring(
                  Math.floor((publicKey.length * 2) / 3),
                  Math.floor((publicKey.length * 3) / 3),
                )}
            </Text>
            <Pressable
              onPress={() => {
